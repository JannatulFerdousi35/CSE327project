...
CREATE INDEX IF NOT EXISTS idx_issue_images_uploaded_by
ON issue_images(uploaded_by);

CREATE INDEX IF NOT EXISTS idx_issue_verifications_issue_id
ON issue_verifications(issue_id);

CREATE INDEX IF NOT EXISTS idx_issue_verifications_user_id
ON issue_verifications(user_id);

CREATE INDEX IF NOT EXISTS idx_ai_analysis_issue_id
ON ai_analysis(issue_id);

CREATE INDEX IF NOT EXISTS idx_action_plans_issue_id
ON action_plans(issue_id);

CREATE INDEX IF NOT EXISTS idx_action_plan_steps_plan_id
ON action_plan_steps(action_plan_id);

CREATE INDEX IF NOT EXISTS idx_volunteer_recommendations_issue_id
ON volunteer_recommendations(issue_id);

CREATE INDEX IF NOT EXISTS idx_volunteer_recommendations_volunteer_id
ON volunteer_recommendations(volunteer_id);
...
CREATE INDEX IF NOT EXISTS idx_volunteer_events_organizer_id
ON volunteer_events(organizer_id);

CREATE INDEX IF NOT EXISTS idx_volunteer_events_issue_id
ON volunteer_events(issue_id);

CREATE INDEX IF NOT EXISTS idx_event_participation_event_id
ON event_participation(event_id);

CREATE INDEX IF NOT EXISTS idx_event_participation_user_id
ON event_participation(user_id);

CREATE INDEX IF NOT EXISTS idx_tasks_action_plan_id
...
CREATE INDEX IF NOT EXISTS idx_resources_action_plan_id
ON resources(action_plan_id);

CREATE INDEX IF NOT EXISTS idx_resources_event_id
ON resources(event_id);

CREATE INDEX IF NOT EXISTS idx_progress_updates_issue_id
ON progress_updates(issue_id);

CREATE INDEX IF NOT EXISTS idx_progress_updates_action_plan_id
ON progress_updates(action_plan_id);

CREATE INDEX IF NOT EXISTS idx_progress_updates_task_id
...
REFERENCES volunteer_events(id)
ON DELETE SET NULL;
END IF;
...
IF NOT EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'notifications_task_id_fkey'
) THEN
    ALTER TABLE notifications
